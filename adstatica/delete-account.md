---
title: AdStatica Account Deletion
permalink: /adstatica/delete-account/
---
...
This page explains how AdStatica users can request account deletion and what happens to linked publisher and synced reporting records.

## 1. Before Deleting Your Account

If you only want to stop AdStatica from accessing a Google publisher account, you can unlink the publisher account in the app where supported. Unlinking removes the backend connection to that publisher account and deletes associated stored Google OAuth tokens.
...
3. Include the email address connected to your AdStatica sign-in account.
4. Include the subject: `AdStatica account deletion request`.
5. If possible, mention whether you want all linked publisher accounts removed or only a specific Google publisher account unlinked.
...
- Your AdStatica account/profile record associated with the signed-in Firebase account.
- Linked Google publisher account records connected to your AdStatica account.
- Stored Google OAuth refresh tokens and access credentials held by the AdStatica backend.
- Synced AdMob and AdSense report rows associated with your AdStatica account.
- Synced app, site, ad-unit, account-health, saved-report, payment/report metadata, and related publisher records associated with your AdStatica account.
...
- Your original Google AdMob, AdSense, or Google account data.
- Apple App Store, Google Play, RevenueCat, Firebase, Google Mobile Ads, or other provider records maintained under their own policies.
...
- iOS: App Store account subscription settings.
